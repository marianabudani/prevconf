<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Botones
                                        <div class="page-title-subheading">Distinta selección de botones.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Transición de color
                                        </h5>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Transición de color sin borde
                                        </h5>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Estado activo
                                        </h5>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Estado deshabilitado
                                        </h5>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Bloque
                                        </h5>
                                        <button class="mb-2 mr-2 btn btn-primary btn-lg btn-block">Grande
                                        </button>
                                        <button class="mb-2 mr-2 btn btn-primary btn-block">Normal
                                        </button>
                                        <button class="mb-2 mr-2 btn btn-primary btn-sm btn-block">Pequeño
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Botones "checkbox"
                                        </h5>
                                        <div class="text-center">
                                            <div role="group" class="btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                                <button type="button" class="btn btn-primary">Uno
                                                </button>
                                                <button type="button" class="btn btn-primary">Dos
                                                </button>
                                                <button type="button" class="btn btn-primary">Tres
                                                </button>
                                            </div>
                                            <div class="divider">
                                            </div>
                                            <div role="group" class="btn-group" data-toggle="buttons">
                                                <button type="button" class="btn btn-danger">Uno
                                                </button>
                                                <button type="button" class="btn btn-danger">Dos
                                                </button>
                                                <button type="button" class="btn btn-danger">Tres
                                                </button>
                                            </div>
                                            <div class="divider">
                                            </div>
                                            <div role="group" class="btn-group-lg btn-group btn-group-toggle" data-toggle="buttons">
                                                <button type="button" class="btn btn-alternate">Uno
                                                </button>
                                                <button type="button" class="btn btn-alternate">Dos
                                                </button>
                                                <button type="button" class="btn btn-alternate">Tres
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">Botones "radio"
                                        </h5>
                                        <div class="text-center">
                                            <div role="group" class="btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
