<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Desplegables
                                        <div class="page-title-subheading">Se encuentra disponible una amplia gama de desplegables.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <div class="card-body"><h5 class="card-title">Básico</h5>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Desplegables divididos</h5>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Desplegables divididos lineales</h5>
                                        <div class="mb-2 mr-2 btn-group">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Posiciones del Menú</h5>
                                        <div class="text-center">
                                            <div class="mb-2 mr-2 dropleft btn-group">
                                                <button class="btn-wide btn btn-primary">Derecha</button>
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dropdown-toggle-split dropdown-toggle btn btn-primary"><span class="sr-only">Toggle Dropdown</span></button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                            ...
                                            <div class="mb-2 mr-2 dropup btn-group">
                                                <button class="btn-wide btn btn-primary">Arriba</button>
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dropdown-toggle-split dropdown-toggle btn btn-primary"><span class="sr-only">Toggle Dropdown</span></button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                            ...
                                            <div class="mb-2 mr-2 dropright btn-group">
                                                <button class="btn-wide btn btn-primary">Izquierda</button>
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="dropdown-toggle-split dropdown-toggle btn btn-primary"><span class="sr-only">Toggle Dropdown</span></button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                        ...
                                        <div class="text-center">
                                            <div class="dropleft btn-group">
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="btn-wide mb-2 mr-2 dropdown-toggle btn btn-primary">Derecha</button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                    <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
                                            ...
                                            <div class="dropup btn-group">
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="btn-wide mb-2 mr-2 dropdown-toggle btn btn-primary">Arriba</button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                    <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
                                            ...
                                            <div class="dropright btn-group">
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="btn-wide mb-2 mr-2 dropdown-toggle btn btn-primary">Izquierda</button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                    <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
                            ...
                            <div class="col-lg-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Lineal</h5>
                                        <div class="dropdown d-inline-block">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Tamaños</h5>
                                        ...
                                        <div class="text-center">
                                            <div class="dropdown d-inline-block">
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2 dropdown-toggle btn btn-primary btn-lg">Grande</button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                    <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2 dropdown-toggle btn btn-primary btn-sm">Pequeño</button>
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                                                    <button type="button" tabindex="0" class="dropdown-item">Menús</button>
                                                    <button type="button" tabindex="0" class="dropdown-item">Configuración</button>
                                                    <h6 tabindex="-1" class="dropdown-header">Cabecera</h6>
