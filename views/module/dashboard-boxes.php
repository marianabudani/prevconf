<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Cajas del panel
                                        <div class="page-title-subheading">Se utilizan para resaltados o mostrar estados numéricos
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card mb-3 widget-content">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Órdenes totales</div>
                                                <div class="widget-subheading">Caja chica</div>
                                            </div>
                                    ...
                                    <div class="card mb-3 widget-content">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                ...
                                                <div class="widget-subheading">Recaudación total</div>
                                            </div>
                                            <div class="widget-content-right">
                                    ...
                                    <div class="card mb-3 widget-content">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                ...
                                                <div class="widget-subheading">Productos inventariados</div>
                                            </div>
                                            <div class="widget-content-right">
