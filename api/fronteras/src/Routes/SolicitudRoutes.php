...
$app->group('/solicitud', function() use ($app) {
    ...
    $app->post('/editar',                \Fronteras\Controllers\SolicitudController::class . ':editarSolicitud');
    ...
    $app->get('/validarchivo',     \Fronteras\Controllers\SolicitudController::class . ':validarchivo');
});